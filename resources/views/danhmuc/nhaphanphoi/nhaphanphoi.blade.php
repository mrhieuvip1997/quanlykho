...
<div class="span16" >
        <div class="box-header">
            <div class="row">
                ...
                <form action="{{ route('danhmuc.nhaphanphoi.getList') }}" method="get">
                    <input id="current-pass-control" name="search" class="span4" type="text" value="" autocomplete="false" placeholder="">
