...
class KhoController extends Controller {
	...
	public function getList(Request $req)
	{
		...
		if ($search) {
			$query->where('kho_ma', 'like','%'.$search.'%');
			$query->orwhere('kho_ten', 'like','%'.$search.'%');
			$query->orwhere('kho_lienhe', 'like','%'.$search.'%');
			$query->orwhere('kho_diachi', 'like','%'.$search.'%');
			$query->orwhere('kho_sdt', 'like','%'.$search.'%');
			$query->orwhere('kho_quanly', 'like','%'.$search.'%');
			$query->orwhere('kho_ghichu', 'like','%'.$search.'%');
		}
		$kho = $query->get();
